...
#
# This script:
#   1. Checks cloudflared is installed and authenticated on the Pi
...
#
# After running this, add DNS records in Cloudflare:
#   cloudflared tunnel route dns <TUNNEL_NAME> <each hostname>
# Or add CNAME records manually pointing to <tunnel-id>.cfargotunnel.com
#
# Prerequisites:
#   - cloudflared must be authenticated on the Pi first:
...
# ─────────────────────────────────────────────────────────────────────────────
# Done — DNS routing instructions
# ─────────────────────────────────────────────────────────────────────────────
echo ""
log_info "════════════════════════════════════════════════════════════"
log_info " Tunnel '$TUNNEL_NAME' is running!"
log_info ""
log_info " Add DNS records in Cloudflare for each hostname:"
log_info ""
